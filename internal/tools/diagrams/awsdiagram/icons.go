...
func (t *AWSDiagramTool) listIcons(provider, service string) (map[string]interface{}, error) {
...
func (t *AWSDiagramTool) getIconRegistry() map[string]map[string]map[string]interface{} {
...
func (t *AWSDiagramTool) getAWSIcons() map[string]map[string]interface{} {
...
func (t *AWSDiagramTool) getGCPIcons() map[string]map[string]interface{} {
	return map[string]map[string]interface{}{
		"compute": {
...
func (t *AWSDiagramTool) getKubernetesIcons() map[string]map[string]interface{} {
	return map[string]map[string]interface{}{
		"workloads": {
...
func (t *AWSDiagramTool) getGenericIcons() map[string]map[string]interface{} {
	return map[string]map[string]interface{}{
		"infrastructure": {
